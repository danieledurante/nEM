...
2. Using the estimates in 1, predict the latent classes ${s}_i$, $i=1,..., n$, by assigning each unit $i$ to the class $r$ with the highest predicted probability.
3. Using the `R` function `multinom` in the library `nnet`, estimate the coefficients $\beta_1,...,\beta_R$ from a multinomial logistic regression with the predicted ${s}_1,...,{s}_n$ as responses.
...
|Averaged Time                              |   0.02988|    0.03980|   0.05957|    0.10077|
...
|Averaged Time                              |         0.208680|        0.2070600|   0.10191|   0.06356|
