...
Consistent with the analyses in Section 3.1 of the paper: [Durante, D., Canale, A. and Rigon, T. (2017). _A nested expectation-maximization algorithm for latent class models with covariates_ [arXiv:1705.03864]](https://arxiv.org/abs/1705.03864), we focus on the latent class model for the `J = 4` different cheating behaviors, having the variable `GPA` (grade point average) as a covariate in the multinomial logistic regression for the latent classes. Using the syntax of the library `poLCA`, this model can be defined as follows:
